...
void showinfo(player &p1, player &p2)//4_??????????????	
{
	...
	cout << "# Intelligence " << setw(3) << (p1.intelligence <= 999 ? p1.intelligence : 999)
		<< " | Luck " << setw(3) << (p1.luck <= 999 ? p1.luck : 999)
		<< " # Intelligence " << setw(3) << (p2.intelligence <= 999 ? p2.intelligence : 999)
		<< " | Luck " << setw(3) << (p2.luck <= 999 ? p2.luck : 999) << " #" << endl;
	cout<<"# EXP"<<setw(8)<<p1.EXP<<"  Job: "<<setw(7);
	p1.showRole();
	cout<<" # EXP"<<setw(8)<<p2.EXP<<" Job: "<<setw(7);
	p2.showRole();
	cout<<"    #"<<endl;
	cout<<"--------------------------------------------------------------"<<endl;
	p1.bag.display();
